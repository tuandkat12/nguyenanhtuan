...
<%-- 					</form:select> --%>
			<hr>
			<label class="iconlable" id="icon" for="fullName"><i class="icon-user"></i></label>
			<input type="text" name="fullName" id="fullName"
				placeholder="Full name" required />
			<label class="iconlable" id="icon" for="phoneNumber"><i class="fa fa-phone" aria-hidden="true"></i></label>
			<input type="text" name="phoneNumber" id="phoneNumber" placeholder="Phone number"
				required />
			<label class="iconlable" id="icon" for="userName"><i class="fa fa-user"></i></label>
			<input type="text" name="userName" id="userName"
				placeholder="Username" required />
			<label class="iconlable" id="icon" for="address"><i class="fa fa-address-book"></i></label>
			<input type="text" name="address" id="address" placeholder="Address"
				required />
			<label class="iconlable" id="icon" for="password"><i class="fa fa-unlock-alt"></i></label>
			<input type="password" name="password" id="password"
				placeholder="Password" required />
			<label class="iconlable" id="icon" for="dateOfBirth"><i class="icon-user"></i></label>
			<input type="text" name="dateOfBirth" id="dateOfBirth"
				placeholder="Birth Day" required />
			<label class="iconlable" id="icon" for="email"><i class="icon-user"></i></label>
			<input type="text" name="email" id="email"
				placeholder="Email" required />
			<label class="iconlable" id="icon" for="identityCard"><i class="fa fa-id-card"></i></label>
